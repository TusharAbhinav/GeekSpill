        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-xl text-zinc-300 max-w-2xl mx-auto mb-6 font-medium">
              Elevate Your Tech Knowledge: Curated Insights, Cutting-Edge Trends, 
              and Industry Breakthroughs at Your Fingertips
            </p>
          ...
          {[
            {
              ...
              description: "Stay ahead with the latest tech trends and in-depth analysis.",
              content: "Real-time updates from industry leaders and innovative startups."
            },
            {
